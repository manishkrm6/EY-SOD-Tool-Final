...
class Upload extends CI_Controller {
	...
	public function upload_file( $path = '')
    {
		...
		//$targetDir = FCPATH . "uploads/Clients/".$folder;
		
		$path = str_replace('.', '/', $path);


		/*connect_master_db();
		$analysis_id = trim($analysis_id);
		...
		$analysis_database = isset($analysisInfo['db_name']) ? $analysisInfo['db_name']*/
	...
	public function upload_db3_sql($folder){
