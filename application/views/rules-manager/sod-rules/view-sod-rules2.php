       ...
       <table id="example" class="table table-striped table-bordered" style="width:100%">
          ...
          <tbody>
               <?php 
                  ...
                  $serial_number = 1;
                  if(!empty($critical_auth)){
                    foreach ($critical_auth as $key => $auth) { ?>

                <tr class="p-0">
					<td style="padding-top:px;">
						<input type="checkbox" name="proc[]" value="<?php echo $auth['tcode'] ?>"><label class="pull-left pt-1 pr-3"for="c14"><?php echo ($serial_number<10)?'0'.$serial_number:$serial_number; $serial_number++; ?></label>
					</td>
