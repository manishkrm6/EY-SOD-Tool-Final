              ...
              <div class=" customgrey col-md-12">
                  <div class="btn-group ">
                   <!--this  is for Add Client-->
                      <a  href="<?php echo base_url('rules-manager/transaction-codes/add-new-transaction-code/'.$client_id) ?>"  class="btn col-sm-10 font-weight-bold"> Add New 
          ...
          <thead class="theadclr fontwt ">
              <tr>
                 <th class=""  style="width:10%;line-height: 1.1857143;"><input type="checkbox" name="cb" class="checkAll">
                  ...
                  <th style="width: 20%">Zcode</th>
                  <th  style="width: 40%">Description</th>
                  <th  style="width: 20%">Process</th>
                  <th  style="width: 20%">Sub Process</th>
				  <th  style="width: 20%">Activity</th>
				  <th  style="width: 20%">Add Information</th>
               ...
               <?php 
                ...
                <tr class="p-0">
					<td style="padding-top:px;">
						<input type="checkbox" name="proc[]" value="<?php echo $activity['activity'] ?>"><label class="pull-left pt-1 pr-3"for="c14"><?php echo ($serial_number<10)?'0'.$serial_number:$serial_number; $serial_number++; ?></label>
					</td>
