              ...
              <div class=" customgrey col-md-12">
                  <div class="btn-group ">
                   <!--this  is for Add Client-->
                       <a  href="<?php echo base_url('rules-manager/conflicts-exceptions/add-new-role-conflict-exception/'.$client_id); ?>"  class="btn col-sm-10 font-weight-bold"> Add New 
               ...
               <?php 
                ...
                <tr class="p-0">
					<td style="padding-top:px;">
						<input type="checkbox" name="proc[]" value="<?php echo $process['proc'] ?>"><label class="pull-left pt-1 pr-3"for="c14"><?php echo ($serial_number<10)?'0'.$serial_number:$serial_number; $serial_number++; ?></label>
					</td>
