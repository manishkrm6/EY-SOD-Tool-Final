              ...
              <div class=" customgrey col-md-12">
                  <div class="btn-group ">
                   <!--this  is for Add Client-->
                      <a  href="<?php echo base_url('rules-manager/manage-activities/add-new-activity/'.$client_id) ?>"  class="btn col-sm-10 font-weight-bold"> Add New 
          ...
          <thead class="theadclr fontwt ">
              <tr>
                 <th class=""  style="width:10%;line-height: 1.1857143;"><input type="checkbox" name="cb" class="checkAll">
                  ...
                  <th  style="width: 40%">Activity Desc</th>
                  <th  style="width: 20%">Act Class</th>
