       ...
       <table id="example" class="table table-striped table-bordered" style="overflow:auto">
          ...
          <tbody>
               ...
               <tr class="p-0" >
                  ...
                  <td><?= $value['CONFLICTID']; ?></td>
                  <td><?= $value['riskid']; ?></td>
                  <td><?= $value['rating']; ?></td>

                  <td><?= $value['ACTIVITY1']; ?></td>
                  <td><?= $value['ACTIVITY1_DESCCRIPTION']; ?></td>
                  <td><?= $value['TCODE1']; ?></td>
                  <td><?= $value['TOCODE1_DESCRIPTION']; ?></td>
                  <td><?= $value['ACTIVITY2']; ?></td>
                  <td><?= $value['ACTIVITY2_DESCCRIPTION']; ?></td>
                  <td><?= $value['TCODE2']; ?></td>
                  <td><?= $value['TOCODE2_DESCRIPTION']; ?></td>
                  <td><?= $value['ACTIVITY3']; ?></td>
                  <td><?= $value['ACTIVITY3_DESCCRIPTION']; ?></td>
                  <td><?= $value['TCODE3']; ?></td>
                  <td><?= $value['TOCODE3_DESCRIPTION']; ?></td>
