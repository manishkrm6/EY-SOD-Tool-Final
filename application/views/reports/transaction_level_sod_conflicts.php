       ...
       <table id="example" class="table table-striped table-bordered" style="overflow:auto">
          ...
          <tbody>
               ...
               <tr class="p-0" >
                  ...
                  <td><?= $value['Activity1_Description']; ?></td>
                  <td><?= $value['TCODE1']; ?></td>
                  <td><?= $value['TCODE1_DESCRIPTION']; ?></td>
                  <td><?= $value['Activity2']; ?></td>
                  <td><?= $value['Activity2_description']; ?></td>
                  <td><?= $value['TCODE2']; ?></td>
                  <td><?= $value['TCODE2_DESCRIPTION']; ?></td>
                  <td><?= $value['Activity3']; ?></td>
                  <td><?= $value['Activity3_Description']; ?></td>
                  <td><?= $value['TCODE3']; ?></td>
                  <td><?= $value['TCODE3_DESCRIPTION']; ?></td>
              </tr>
              <?php $sn++; } } ?>
          </tbody>
          <!--table body end-->
