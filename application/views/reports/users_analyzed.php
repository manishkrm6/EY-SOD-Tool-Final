     ...
     <!--Add Client delete client code end-->
       ...
       <table id="example" class="table table-striped table-bordered" style="overflow:auto">
          <thead class="theadclr fontwt" style="white-space:nowrap!important;overflow:auto!important">
              <tr>
                 <th class=""  style="width:10%;line-height: 1.1857143;">
                 <!-- <input type="checkbox" name="cb" class="checkAll"> -->
                  ...
                  <th  style="width: 20%">SOD Risk</th>
                  <th  style="width: 20%">SOD Conflicts</th>
              </tr>
          </thead>
          <tbody>
               <?php 
                  ...
                  if(!empty($list)){
                    foreach ($list as $key => $value) {
                        ...
                        $valid_to = $value['valid_to'] != "00000000" ? short_date_format($value['valid_to']) : '00000000';
               ?>
               <tr class="p-0" >
                  ...
                  <td><?= $value['SOD_RISK']; ?></td>
                  <td><?= $value['SOD_CONFLICTS']; ?></td>
              </tr>
              <?php $sn++; } } ?>
          </tbody>
          <!--table body end-->
