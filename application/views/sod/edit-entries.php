...
<div class="page-title-box">
    ...
    <h4 class="page-title">Edit Entries of <?php echo $table_name ?></h4>
        ...
        <div class="col-12">
            <div class="card">
                            ...
                            foreach ($table_data as $key => $table) { ?>
                              ...
                              <?php foreach ($columns as $key => $column) { ?>
                                <td class="text-center">
                                    <input type="text" name="<?php echo $column['Field'] ?>[]" value="<?php echo trim($table[$column['Field']]) ?>"></td>
                            <?php } ?>
                                </tr>
                            <?php }
                        } ?>
                ...
                <div class="text-center">
                    <input type="submit" name="update_entries" class="btn btn-success">
                </div>
                </form>
                </div> <!-- end card body-->
            </div> <!-- end card -->
