    ...
    <div class="row">
        <?php 
                ...
                if(!empty($list_sql_files)){
                    ...
                    $insert_array['client_name'] = $client;
    ...
    <div class="card">
            ...
            <table id="datatable-buttons" class="table table-bordered table-striped dt-responsive nowrap w-100">
                ...
                <?php
                    ...
                    connect_master_db();
                    $list_databases = $this->common_model->get_entry_by_data('list_analysis',false,['status'=> 1],'','DESC','id');
                    ...
                    <tr>
                        ...
                        <td> <?php echo $value['analysis_name']; ?></td>
                        <td><?= $value['client_name']; ?></td>
                        <td><?= $value['system_type']; ?></td>
                        <td><a href="<?= base_url('import-files/'.id_encode($value['id'])) ?>">Ready For Import</a></td>
                    </tr>
                    <?php } } ?>
                </tbody>
            </table>          
