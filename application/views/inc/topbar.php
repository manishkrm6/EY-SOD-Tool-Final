       <!-- Begin page -->
        <div id="wrapper"> <!-- This will end in inc/footer.php -->
<!-- Topbar Start -->
                ...
                <div class="container-fluid">
                    <ul class="list-unstyled topnav-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                ...
                                <!-- item-->
                                <a href="<?php echo base_url('my-profile') ?>" class="dropdown-item notify-item">
                                    <i class="fe-user"></i>
                    ...
                    <div class="logo-box">
                        <a href="<?php echo base_url() ?>" class="logo logo-dark text-center">
                            <span class="logo-sm">
                                <img src="<?php echo base_url('assets/images/white-logo.png') ?>" alt="" height="22">
                                <!-- <span class="logo-lg-text-light">UBold</span> -->
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo base_url('assets/images/white-logo.png') ?>" alt="" height="20">
                        ...
                        <a href="<?php echo base_url() ?>" class="logo logo-light text-center">
                            ...
                            <span class="logo-lg">
                                <img src="<?php echo base_url('assets/images/white-logo.png') ?>" alt="" height="70">
                            </span>
                        </a>
                    </div>
